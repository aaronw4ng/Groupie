...
public class IndicateResponseServletTest {
    ...
    public void testDoPost() throws Exception {
        ...
        Mockito.doReturn("1").when(request).getParameter("eventId");
        Mockito.doReturn("2").when(request).getParameter("userId");
        Mockito.doReturn("yes").when(request).getParameter("availability");
        Mockito.doReturn("4").when(request).getParameter("excitement");
        IndicateResponseServlet servlet = new IndicateResponseServlet();
        servlet.init(config);
